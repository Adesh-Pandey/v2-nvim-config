...
set_keymap("n", "<leader>h", ':lua require("harpoon.ui").toggle_quick_menu()<CR>', { noremap = true, silent = true })

set_keymap("n", "<leader>m", ':lua require("harpoon.mark").toggle_quick_menu()<CR>', { noremap = true, silent = true })
